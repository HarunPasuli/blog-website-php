...
<body>
<form method="POST" action="UserInsert.php" id="upload-form" enctype="multipart/form-data">
<h1 style = "text-align: center;">Insert Blog</h1>
    ...
    <div class="form-group">
        ...
        <div class="file-upload">
            <input type="file" name="fileUpload" id="file-upload" accept="image/png, image/jpeg, image/jpg" onchange="getFileData()">
    ...
    <div class="form-group">
        ...
        <div class="file-upload">
            <input type="file" name="fileProfilePicture" id="file-profile-picture" accept="image/png, image/jpeg, image/jpg" onchange="getFileData2()">
            <span class="file-upload-text">Drag and drop or click to select file</span>
        </div>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if ($file_size > $max_size || $file_size2 > $max_size) {
        ...
        Swal.fire({
          ...
          confirmButtonText: 'OK'
            ...
            window.open('UserInsert.php','_self');
        });
        </script>";
        exit();
    }
    ...
    if (isset($_POST['upload'])) {
        ...
        if ($fileName == '' || $fileUpload == '' || $fileProfilePicture == '' || $filePersonalName == '' || $fileDescription == '') {
            ...
            $insert = "SELECT * FROM userproducts WHERE fileName = '$fileName' OR fileUpload = '$fileUpload' LIMIT 1";
            ...
            if ($exist) {
                ...
                $uploadPath = "../AdminDashboard/admin/Approve/file/";
                ...
                if (($uploadFileError == 0) && ($uploadProfilePictureError == 0)) {
                    if(move_uploaded_file($fileUpload_temp, $uploadFile) && move_uploaded_file($fileProfilePicture_temp, $uploadProfilePicture)) {
                        $uploadFile = "INSERT IGNORE INTO userproducts(fileName,fileUpload,fileDescription,fileProfilePicture,filePersonalName,fileCategories,Email) VALUES('$fileName','$fileUpload','$fileDescription','$fileProfilePicture','$filePersonalName','$fileCategories','$email');";
