...
<header>
  <div class="nav container">
    ...
    if (isset($_SESSION['Email'])) {
      ...
      <div class = "dropdown">
      <a href="#" class="login">
        <?php      $connect=mysqli_connect('localhost','root','','website_blog_hp');
        mysqli_select_db($connect,'website_blog_hp');
        ...
        <div class="dropdown-content">
          ...
          <?php 
            ...
            if($_SESSION['Role'] == 2) {
              echo "<a href = '../AdminDashboard/writers/index.php'> Writer Dashboard </a>";
            }
          ?>
    ...
    if(isset($_GET['id']))
    {
        ...
        $select = "SELECT * FROM userproducts WHERE PID = '$id'";
    ...
    <section class="post-header">
        <div class="header-content post-container">
            <a href="approve.php" class="back-home">Back To Home</a>
            <h1 class="header-title"> <?php echo $fileName ?> </h1>
            <img src="file/<?php echo $fileUpload;?>" alt="" class="header-img">
        </div>
    </section>
